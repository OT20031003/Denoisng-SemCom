...
def main():
    ...
    parser.add_argument("--recv", "-r", default="./outputs/e=-3", help="Directory for 'received' images (comparison target 1)")
    parser.add_argument("--recv2", "-r2", default="./outputs/e=0", help="Directory for 'received' images (comparison target 2)")
    # --- ⭐ NEW: Added recv3 argument ---
    parser.add_argument("--recv3", "-r3", default="./outputs/e=3", help="Directory for 'received' images (comparison target 3, optional)")
    ...
    # --- ⭐ NEW: Get label3 only if recv3 is provided ---
    label3 = None
    if args.recv3:
