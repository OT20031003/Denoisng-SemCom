...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        nargs="?",
        help="dir to write results to",
        default=f"outputs/nonoisenosample/e={e_level}"
    )
    ...
    for snr in range(-3, 5, 1):
        ...
        noise_variances_predict = snr + e_level # 誤差付きの予測値
        print(f"@@@@@@@@@@@@@{noise_variances_predict} dB @@@@@@@@@@@")
        noise_variances_predict = pow(10, noise_variances_predict/10.0)
        noise_variances_predict = torch.full_like(z_variances, noise_variances_predict) 
